...
<div class="container">
	<div class="main">
		<div class="main-center">
			<h3>Edit Form Customer</h3>


			@foreach($data as $d)
			<form class="" method="post" action="{{route('customermodel.update',$d->id)}}">
				@csrf
				@method('PUT')			
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" name="nama" id="name"  placeholder="Nama lengkap" value="{{$d->namacustomer}}" />
					</div>
				</div>
