...
<br>
	...
	<div class="container-contact100">
			...
			<form class="contact100-form validate-form" action="{{route('pesanmodel.store')}}" method="POST" >
                ...
                @endphp
					...
					<select name="ncm"  class="input100" id="exampleFormControlSelect1">
				...
				<div class="wrap-input100 validate-input" data-validate="Harus di isi!!">
					<span class="label-input100"> Jenis Jasa</span>
					<br>
					<select name="jasa"  class="input100" id="exampleFormControlSelect1">
				...
				<div class="wrap-input100 validate-input" data-validate = " harus di isi!!">
					<span class="label-input100">Keluhan</span>
					<textarea class="input100" name="keluhan"></textarea>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "harus di isi!!">
					<span class="label-input100">Jumlah unit</span>
					<input class="input100" type="number" name="jml" >
					<span class="focus-input100"></span>
				</div>


				<div class="wrap-input100 validate-input" data-validate="Harus di isi!!">
					<span class="label-input100"> Jenis AC</span>
					<br>
					<select name="ac"  class="input100" id="exampleFormControlSelect1">
	                <option>---Pilih Jenis AC---</option>
                 <option value="split">Split</option>
                 <option value="window">Window</option>
                 <option value="central">Central</option>
                 <option value="standing">Standing</option>
                 <option value="casette">Cassete</option>
	                </select>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Harus di isi!!">
					<span class="label-input100"> Jenis Ukuran</span>
					<br>
					<select name="size"  class="input100" id="exampleFormControlSelect1">
				...
				<div class="wrap-input100 validate-input" data-validate="Harus di isi!!">
					<span class="label-input100"> Jenis Bangunan</span>
					<br>
					<select name="bgn"  class="input100" id="exampleFormControlSelect1">
				...
				<div class="wrap-input100 validate-input">
					...
					<input class="input100" type="number" name="harga" >
					<span class="focus-input100"></span>
				</div>
